...
export const projects: Project[] = [
  ...
  },
  {
    ...
    orientation: 'portrait',
    images: [
      { url: '/images/03/Project/SF1.webp', orientation: 'portrait' },
      { url: '/images/03/Project/SF2.webp', orientation: 'portrait' },
      { url: '/images/03/Project/SF3.webp', orientation: 'portrait' },
      { url: '/images/03/Project/SF4.webp', orientation: 'portrait' },
      { url: '/images/03/Project/SF5.webp', orientation: 'portrait' },
      { url: '/images/03/Project/SF6.webp', orientation: 'portrait' },
      { url: '/images/03/Project/SF7.webp', orientation: 'landscape' },
      { url: '/images/03/Project/SF8.webp', orientation: 'portrait' },
    ]
  },
  {
    slug: '02',
